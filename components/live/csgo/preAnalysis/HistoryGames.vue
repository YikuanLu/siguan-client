        ...
        <tbody>
          {recentMatches.map((item) => {
            return (
              <tr>
                <td width="8%">
                  <GameTypeIcon class="game-icon" type="csgo"/>
                </td>
                <td width="20%" align="left" title={item.leagueName}>
                  <span class="game-name"
                    onClick={ () => {
                      openMatchLeagueUrl(this, { gameType: 'csgo', id: item.leagueId })
                    }}
                ...
                <td>
                  <a-button class="game-link">
                    <nuxt-link to={`/live/csgo/${item.matchId}?tab=4`} target="_blank">数据</nuxt-link>
                  </a-button>
                  <a-button class="game-link">
                    <nuxt-link to={`/live/csgo/${item.matchId}?tab=2`} target="_blank">指数</nuxt-link>
                  </a-button>
                </td>
              </tr>
            )
