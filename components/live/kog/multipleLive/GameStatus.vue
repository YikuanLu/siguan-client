...
export default {
  ...
  data () {
    return {
      ...
      smallDragonImg: require('@/static/img/common/kog-small-dragon.png'),
      bigDragonImg: require('@/static/img/common/kog-big-dragon.png'),
      towerImg: require('@/static/img/common/kog-tower.png')
    }
  },
  computed: {
  ...
  render () {
    ...
    const infoData = this.battleData
    const {
      team_stats_a: blueSide,
      team_stats_b: redSide
    } = infoData
