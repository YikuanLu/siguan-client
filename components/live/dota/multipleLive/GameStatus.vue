...
export default {
  ...
  render () {
    ...
    const [blueSide, redSide] = [teams[0], teams[1]]
    ...
    const score = (
      <div class="top-score">
        ...
        <img class="team-logo left" src={blueSide.logo} alt=""/>
        <div class="team-name left">
          <p class="name">{blueSide.name}</p>
          <p class="money">
            <icon-font class="coin" type="iconjinbi"></icon-font>
            <span class="num">{blueSide.gold}</span>
          </p>
        </div>
        ...
        <div class="team-name right">
          <p class="name">{redSide.name}</p>
          <p class="money">
            <span class="num">{redSide.gold}</span>
            <icon-font class="coin" type="iconjinbi"></icon-font>
          </p>
        </div>
        <img class="team-logo right" src={redSide.logo} alt=""/>
    ...
    const timeStatus = (
      <div class="status-get">
        <div class="center">
          ...
          <div class="time">{secondToHs(data.duration)}</div>
    ...
    // 渲染图片
    const renderImgs = data => data.map(item => <img class="hero" title={item.name_cn} src={item.logo} alt=""/>)
