  ...
  render () {
    ...
    const title = (
      <div class="history-title">
        <div class="team"
          onClick={ () => {
            openMatchTeamUrl(this, { gameType: 'dota', id: teamA.teamId })
          }}
        >
        ...
        <div class="team"
          onClick={ () => {
            openMatchTeamUrl(this, { gameType: 'dota', id: teamB.teamId })
          }}
        >
        ...
        <tbody>
          {recentList.map((item) => {
            return (
              <tr>
                <td width="8%">
                  <GameTypeIcon class="game-icon" type="dota"/>
                </td>
                <td width="20%" align="left" title={item.leagueName}>
                  <span class="game-name"
                    onClick={ () => {
                      openMatchLeagueUrl(this, { gameType: 'dota', id: item.leagueId })
                    }}
                ...
                <td><span class="team-name-short">{item.teamAName}</span></td>
                <td>
                ...
                <td><span class="team-name-short">{item.teamBName}</span></td>
                <td>
                  <a-button class="game-link">
                    <nuxt-link to={`/live/dota/${item.matchId}?tab=4`} target="_blank">数据</nuxt-link>
                  </a-button>
                  <a-button class="game-link">
                    <nuxt-link to={`/live/dota/${item.matchId}?tab=2`} target="_blank">指数</nuxt-link>
                  </a-button>
                </td>
              </tr>
            )
