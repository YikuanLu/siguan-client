  ...
  render () {
    return (
      <div class="userAgreement">
        <div class="wrap-box">
          <div class="header">
            <p class="title">尚牛电竞用户协议</p>
            <p class="time">2019-11-20 10:10:10</p>
          </div>
          <div class="content">
            <p>
              <span>欢迎您使用尚牛电竞的服务!</span>
            </p>
            <p></p>
            <p>
              <span>
            ...
            <p></p>
            <p>
              <span>四、用户个人信息保护</span>
            </p>
            <p></p>
            <p>
              <span>1. 保护您的个人信息是尚牛电竞的一项基本原则。</span>
            </p>
            <p></p>
            <p>
              <span>
            ...
            <p></p>
            <p>
              <span>7.1 您或您监护人授权尚牛电竞披露的;</span>
            </p>
            <p></p>
            <p>
              <span>7.2 有关法律要求尚牛电竞披露的;</span>
            </p>
            <p></p>
            <p>
              <span>7.3 司法机关或行政机关基于法定程序要求尚牛电竞提供的;</span>
            </p>
            <p></p>
            <p>
              <span>
            ...
            <p></p>
            <p>
              <span>7.5 应您监护人的合法要求而提供您个人身份信息时。</span>
            </p>
            <p></p>
            <p>
              <span>五、使用本服务的方式</span>
            </p>
            <p></p>
            <p>
              <span>1. 您对登录后所持账号产生的行为依法享有权利和承担责任</span>
            </p>
            <p></p>
            <p>
              <span>
            ...
            <p></p>
            <p>
              <span>( 3 )恶意虚构事实、隐瞒真相以误导、欺骗他人;</span>
            </p>
            <p></p>
            <p>
              <span>( 4 )发布、传送、传播广告信息及垃圾信息;</span>
            </p>
            <p></p>
            <p>
              <span>( 5 )其他法律法规禁止的行为。</span>
            </p>
            <p></p>
            <p>
              <span>
            ...
            <p></p>
            <p>
              <span>十五、用户发送、传播的内容与第三方投诉处理</span>
            </p>
            <p></p>
            <p>
              <span>
            ...
            <p></p>
            <p>
              <span>( 4 )您通过非尚牛电竞授权的方式使用本服务;</span>
            </p>
            <p></p>
            <p>
              <span>
            ...
            <p></p>
            <p>
              <span>十九、管辖与法律适用</span>
            </p>
            <p></p>
            <p>
              <span>1. 本协议签订地为中华人民共和国福建省厦门市思明区。</span>
            </p>
            <p></p>
            <p>
              <span>
            ...
            <p></p>
            <p>
              <span>5. 在监护人或老师的指导下，学习正确使用网络;</span>
            </p>
            <p></p>
            <p>
              <span>
            ...
            <p></p>
            <p>
              <span>本协议最终解释权归厦门思冠科技有限公司所有。</span>
            </p>
            <p></p>
            <p>
              <span>
